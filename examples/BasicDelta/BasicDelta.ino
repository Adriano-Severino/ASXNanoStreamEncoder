...
// Pré-aloca 128 bytes para mitigar fragmentação de heap na SRAM de placas com pouca memória (ex: Arduino Uno)
AsxNanoStream asx(128);
...
void setup() {
  ...
  // Saída esperada: B250#x3-+0v6000msx2-+1v6000ms
